  ...
  <div class="card">
    ...
    <form @submit.prevent="submit">
        <div class="input-container">
            <input id="email" type="email"  required="required"  v-model="form.email" autofocus autocomplete="email">
        ...
        <div class="block mt-4 mx-[60px] mb-5">
        ...
        <div class="button-container">
            <button type="submit" :class="{ 'opacity-25': form.processing }" :disabled="form.processing"><span>ادامه</span></button>
        </div>
